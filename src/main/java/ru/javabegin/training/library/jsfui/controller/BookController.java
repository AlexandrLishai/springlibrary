...
public class BookController extends AbstractController<Book> {
    ...
    private UploadedFile uploadedImageNotAjax;
    ...
    public void saveImage() {
        ...
        bookDao.save(selectedBook);
        RequestContext.getCurrentInstance().execute("PF('dialogEditImageBook').hide()");
    ...
    public void addActionEditImage() {
        uploadedImage = selectedBook.getImage();

        RequestContext.getCurrentInstance().execute("PF('dialogEditImageBook').show()");
    }
    ...
    public void uploadImageNotAjax() {
        uploadedImage = uploadedImageNotAjax.getContents();
        saveImage();
    }
